...
df=pd.read_excel("D:\\FRIDAY\\birthday.xlsx") #file path for friends email and birthday
...
message.attach(MIMEText("""Happy Birthday to the best person on the planet
regards,
Mehul"""
, 'plain'))
